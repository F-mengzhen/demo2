package com.example.demo2.cn.edu.sdjzu.xg.bysj.dao;
...
public final class DepartmentDao {
  ...
  public Collection<Department> findAll()throws SQLException {
    ...
    Connection connection= com.example.demo2.util.JdbcHelper.getConn();
    //执行sql查询语句，并获得结果集
    ...
    com.example.demo2.util.JdbcHelper.close(stmt,connection);
  ...
  public boolean update(Department department)throws SQLException{
    ...
    com.example.demo2.util.JdbcHelper.close(pstmt,connection);
